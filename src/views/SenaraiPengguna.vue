...
export default {
  ...
  methods: {
    getAllPegawai() {
      axios.request({
        methods: "GET",
        url: "https://backend-aduan.amiersiddiq.com/api/pegawai/list",
    ...
    async getDetailPegawai(id) {
      axios.request({
        method: "GET",
        url: `https://backend-aduan.amiersiddiq.com/api/pegawai/detail/${id}`,
        headers: { Authorization: "Bearer " + localStorage.getItem("token") },
      }).then((response) => {
        if (response.status == 200) {
    ...
    gantungPegawai(id) {
      axios.request({
        method: "PUT",
        url: `https://backend-aduan.amiersiddiq.com/api/pegawai/gantung/${id}`,
        headers: { Authorization: "Bearer " + localStorage.getItem("token") },
      }).then((res) => {
        if (res.status == 200) {
    ...
    aktifPegawai(id) {
      axios.request({
        method: "PUT",
        url: `https://backend-aduan.amiersiddiq.com/api/pegawai/aktif/${id}`,
        headers: { Authorization: "Bearer " + localStorage.getItem("token") },
      }).then((res) => {
        if (res.status == 200) {
          this.getDetailPegawai(id)
