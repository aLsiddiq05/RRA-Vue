      ...
      try {
        ...
        if (this.roleId === 3) {
          response = await axios.request({
            method: "get",
            url: `https://backend-aduan.amiersiddiq.com/api/aduan/my/${aduanId}`,
            headers: {
          ...
          response = await axios.request({
            method: "get",
            url: `https://backend-aduan.amiersiddiq.com/api/aduan/aduanDetail-Pegawai/${aduanId}`,
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          });
    ...
    async updateStatus(status) {
      ...
      try {
        ...
        if (this.roleId === 3 && status === 4) {
          ...
          response = await axios.request({
            method: "put",
            url: `https://backend-aduan.amiersiddiq.com/api/aduan/cancel/${aduanId}`,
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
          });
          ...
          if (status === 4) {
            response = await axios.request({
              method: "put",
              url: `https://backend-aduan.amiersiddiq.com/api/aduan/pegawai/tolak/${aduanId}`,
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
            });
            ...
            response = await axios.request({
              method: "put",
              url: `https://backend-aduan.amiersiddiq.com/api/aduan/pegawai/terima/${aduanId}`,
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
            });
            ...
            response = await axios.request({
              method: "put",
              url: `https://backend-aduan.amiersiddiq.com/api/aduan/pegawai/selesai/${aduanId}`,
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
              data: {
